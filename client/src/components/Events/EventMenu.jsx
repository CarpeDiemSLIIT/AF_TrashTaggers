...
import { deleteCevent } from "../../features/cevents/ceventSlice";
import EditPostFrom from "../Posts/EditPostFrom";
import EditEventForm from "./EditEventForm";

export default function CeventMenu({ authorId, post }) {
  ...
  return (
    <>
      ...
      <Dialog open={isDialogOpenEdit} onClose={handelCancelEdit}>
        ...
        <DialogContent>
          <EditEventForm handleClose={handleCloseEdit} cevent={post} />
        </DialogContent>
      </Dialog>
    </>
  );
